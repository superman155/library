<template>
	<div :style='{"alignContent":"flex-start","padding":"0 10%","margin":"0px auto","alignItems":"flex-start","flexWrap":"wrap","background":"none","display":"flex","width":"100%","position":"relative"}'>
		...
		<div v-if="storeupType==1" class="section-title" :style='{"padding":"0","borderColor":"#000","color":"#333","textAlign":"center","background":"none","borderWidth":"4px","display":"block","width":"100%","lineHeight":"60px","fontSize":"30px","borderStyle":"double","fontWeight":"500"}'>我的收藏</div>
		<div v-if="storeupType==21" class="section-title" :style='{"padding":"0","borderColor":"#000","color":"#333","textAlign":"center","background":"none","borderWidth":"4px","display":"block","width":"100%","lineHeight":"60px","fontSize":"30px","borderStyle":"double","fontWeight":"500"}'>我的点赞</div>
		<div v-if="storeupType==81" class="section-title" :style='{"padding":"0","borderColor":"#000","color":"#333","textAlign":"center","background":"none","borderWidth":"4px","display":"block","width":"100%","lineHeight":"60px","fontSize":"30px","borderStyle":"double","fontWeight":"500"}'>我的评论</div>
