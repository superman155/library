		...
		<div class="detail-preview">
			<div class="attr">
				<div class="info">
					...
					<div class="btn_box">
						<el-button class="editBtn" v-if="btnAuth('gongzuorenyuan','修改')&&detail.sfsh!='是'&&detail.sfsh!='否' " @click="editClick">修改</el-button>
						<el-button class="delBtn" v-if="btnAuth('gongzuorenyuan','删除')" @click="delClick">删除</el-button>
						<el-button class="auditBtn" v-if="btnAuth('gongzuorenyuan','审核') && (detail.sfsh=='待审核'||!detail.sfsh)" @click="onSH" type="warning">审核</el-button>
						<el-button class="editBtn" @click="allchapterClick()" type="warning" v-if="btnAuth('gongzuorenyuan','章节管理')">章节管理</el-button>
					</div>
				</div>
			</div>
...
<script>
	...
	export default {
		...
		methods: {
			...
			// 删除
			async delClick(){
				await this.$confirm('是否删除此工作人员？') .then(_ => {
			...
			allchapterClick (){
				...
				this.$router.push({path: '/index/chaptergongzuorenyuan', query: params});
			},
			// 获取uuid
			getUUID() {
