<template>
	<div class="main-content" :style='{"padding":"50px 30px 30px"}'>
		...
		<div v-if="!showFlag" style="width: 100%;">
			<el-form :style='{"border":"1px solid #00000050","padding":"0","margin":"0 0 0px","borderRadius":"10px 10px 0 0","background":"#fff","borderWidth":"1px 1px 0","width":"100%"}' :inline="true" :model="searchForm" class="center-form-pv">
				<el-row :style='{"padding":"20px 10px 0px","boxShadow":"none","borderColor":"#00000050","borderRadius":"0px","flexWrap":"wrap","borderWidth":"0 0 1px","display":"flex","width":"100%","position":"relative","borderStyle":"solid"}'>
					...
					<el-button class="search" :style='{"border":"0","cursor":"pointer","padding":"0 12px 0 10px","outline":"none","color":"#fff","borderRadius":"0px","background":"linear-gradient(126.43deg, rgba(221, 61, 249, 1),rgba(125, 78, 251, 1) 100%)","width":"auto","fontSize":"16px","height":"36px"}' type="success" @click="search()">
				...
				<el-table
					...
					<el-table-column
						...
						<template slot-scope="scope">
							<el-button
								type="text"
								:style='{"border":"0","cursor":"pointer","padding":"0 10px","margin":"0 5px 5px 0","outline":"none","color":"#dc3dfa","borderRadius":"6px","background":"#fbe5ff","width":"auto","fontSize":"14px","height":"32px","order":"-1"}'
								size="small"
