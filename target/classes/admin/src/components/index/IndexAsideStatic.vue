...
// 					// }
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 .el-submenu.other /deep/ .el-submenu__title {
		...
		box-shadow: 0px 4px 3px #8558ff !important;
		color: #000 !important;
	...
	.scrollbar-wrapper-open .el-menu-vertical-2 /deep/ .el-submenu.other .el-menu {
		...
		padding: 10px;
		margin: 5px 0 0;
		background: linear-gradient(135.00deg, rgba(222, 61, 250, 1),rgba(123, 79, 251, 1) 100%);
	}
