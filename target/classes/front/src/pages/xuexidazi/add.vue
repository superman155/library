	...
	<div class="add-update-preview">
		<el-form
			...
			<el-form-item class="add-item"  label="学习风格" prop="xuexifengge">
				<el-select v-model="ruleForm.xuexifengge" placeholder="请选择学习风格" :disabled="ro.xuexifengge"  filterable>
					<el-option
			...
			<el-form-item class="add-item"  label="监督机制" prop="jiandujizhi">
				<el-select v-model="ruleForm.jiandujizhi" placeholder="请选择监督机制" :disabled="ro.jiandujizhi"  filterable>
					<el-option
			...
			<el-form-item class="add-item"  label="搭子类型" prop="dazileixing">
				<el-select v-model="ruleForm.dazileixing" placeholder="请选择搭子类型" :disabled="ro.dazileixing"  filterable>
					<el-option
...
<script>
	export default {
		...
		methods: {
			...
			// 多级联动参数
			async info() {
				await this.$http.get(`xuexidazi/detail/${this.$route.query.id}`, {emulateJSON: true}).then(res => {
					if (res.data.code == 0) {
			...
			async onSubmit(subMitType=null) {
				await this.$refs["ruleForm"].validate(async valid => {
					if(valid) {
						...
						await this.$http.post(`xuexidazi/${this.ruleForm.id?'update':this.centerType?'save':'add'}`, this.ruleForm).then(async res => {
							if (res.data.code == 0) {
								await this.$message({
									message: '操作成功',
									type: 'success',
